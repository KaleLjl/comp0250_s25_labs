    ...
    (const sensor_msgs::PointCloud2ConstPtr &cloud_input_msg)
  {
    ...
    {
      apply_filter(g_cloud_ptr, g_cloud_filtered_octomap);
  ...
  void
  cw2::apply_filter(PointCPtr &in_cloud_ptr,
  ...
  bool
  cw2::pickAndPlace(geometry_msgs::Point objectPoint, 
  ...
  cw2::task_2(std::vector<geometry_msgs::PointStamped> ref, geometry_msgs::PointStamped mystery){
    ...
    std::string ref_shape_1 = check_shape(ref[0].point);
    ...
    std::string mystery_shape = check_shape(mystery.point);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::string
  cw2::check_shape(geometry_msgs::Point point){
  ...
  cw2::task_3()
  {
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> clusters = cluster_point_clouds(cloud);
    ...
    for (auto cluster : clusters)
    {
      ...
      else
      {
        ...
        double width = get_cluster_width(cluster)/5.0;
    ...
    for (auto object : object_positions)
    {
      ...
      // Identify the object
      Object target_obj = check_object();
  ...
  cw2::cluster_point_clouds(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud)
  {
  ...
  double 
  cw2::get_cluster_width(pcl::PointCloud<pcl::PointXYZ>::Ptr cluster)
  {
